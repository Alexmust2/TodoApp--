<template>
    <div class="list__container"> 
        ...
        @drop="drop">
            ...
            @dragend="dragEnd($event, index, task)"
            >
                <span 
                class="task__title"
...
export default  {
    ...
    data() {
        return {
            tasks:[
                {title: "Описать правила поведения интерфейса", isOpen: false, editMode: false, Delete: false, isActive: false},
            ],
            addedText: "",
            addMode: false,
            activeIndex: null,
    ...
    methods: {
        ...
        saveText() {
            ...
            this.addedText = ''
            this.$notify({
                title: 'Задача создана в «На согласовании»',
        ...
        drop(event) {
            ...
            this.$notify({
                title: 'Задача перенесана в «На согласовании»',
                text: task.title,
            });
        },
        updateText(title){
